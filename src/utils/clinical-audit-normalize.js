...
export function normalizeClinicalAuditItem(raw) {
  ...
  return {
    ...
    eventClass: String(
      raw.event_class ?? raw.eventClass ?? '',
    ).trim(),
    triggeredBy: raw.triggered_by ?? raw.triggeredBy ?? null,
    triggeredByName: String(
      raw.triggered_by_name ?? raw.triggeredByName ?? '',
    ).trim(),
  }
}
...
const ACTION_I18N_KEYS = {
  ...
  CLINICAL_NOTE_SIGNED: 'clinicalAuditActionClinicalNoteSigned',
  STATUS_CHANGED: 'clinicalAuditActionStatusChanged',
  STARTED: 'clinicalAuditActionStarted',
  COMPLETED: 'clinicalAuditActionCompleted',
  ENCOUNTER_COMPLETED: 'clinicalAuditActionEncounterCompleted',
...
const ENTITY_I18N_KEYS = {
  ...
  VITAL: 'clinicalAuditEntityVitals',
  VITALS: 'clinicalAuditEntityVitals',
  CLIENT_MEDICATION: 'clinicalAuditEntityMedication',
  ...
  ENCOUNTER: 'clinicalAuditEntityEncounter',
  INSURANCE_PROFILE: 'clinicalAuditEntityInsurance',
  INSURANCE: 'clinicalAuditEntityInsurance',
  FAMILY_MEDICAL_HISTORY: 'clinicalAuditEntityFamilyMedicalHistory',
  MEDICAL_HISTORY: 'clinicalAuditEntityMedicalHistory',
  SOCIAL_HISTORY: 'clinicalAuditEntitySocialHistory',
  ENCOUNTER_NARRATIVE: 'clinicalAuditEntityEncounterNarrative',
