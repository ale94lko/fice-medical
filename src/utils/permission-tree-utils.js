...
const MODULE_LABELS = {
  ...
  CLINICAL_NOTE_TEMPLATE: 'Clinical Note Templates',
  CLINICAL_NOTE_TEMPLATE_VIEW: 'Clinical Note Templates',
  CLINICAL_NOTE_TEMPLATE_CREATE: 'Clinical Note Templates',
  CLINICAL_NOTE_TEMPLATE_EDIT: 'Clinical Note Templates',
  CLINICAL_NOTE_TEMPLATE_DUPLICATE: 'Clinical Note Templates',
  CLINICAL_NOTE_TEMPLATE_ACTIVATE: 'Clinical Note Templates',
  CLINICAL_NOTE_TEMPLATE_DEACTIVATE: 'Clinical Note Templates',
  ENCOUNTER_NARRATIVE: 'Encounter Narrative',
  CLINICAL_NOTE_REGENERATE: 'Clinical Notes',
...
const MODULE_ICONS = {
  ...
  CLINICAL_NOTE_TEMPLATE: 'description',
  ENCOUNTER_NARRATIVE: 'notes',
  STAFF_MEMBERS: 'badge',
  TELEHEALTH: 'videocam',
