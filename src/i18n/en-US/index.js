export default {
  ...
  subtenantStateLabel: 'State',
  subtenantStateRequired: 'State is required.',
  ...
  serviceProcedureNoClinicalNoteTemplate: 'None',
  ...
  serviceProcedureShowInClinicLabel: 'Show in clinic',
  serviceProcedureShowInPortalLabel: 'Show in portal',
  serviceProcedureShowInClinicShortLabel: 'Clinic',
  serviceProcedureShowInPortalShortLabel: 'Portal',
  serviceProcedureVisibilityRequired:
    'The service must be visible in the clinic, the portal, or both.',
  ...
  serviceProcedureBillableShortLabel: 'Billable',
  serviceProcedureBillableLabel: 'Billable service',
  serviceProcedureBillableHint:
    'Include this service in billing when performed '
    + 'during an Encounter.',
  serviceProcedureDefaultUnitsLabel: 'Default units',
  serviceProcedureBillingCodeRequired:
    'A CPT or HCPCS code is required for a billable service.',
  serviceProcedureBillingCodeAmbiguous:
    'A billable service cannot have both a CPT and an HCPCS code.',
  serviceProcedureDefaultFeeRequired:
    'Default Fee is required for a billable service.',
  serviceProcedureDefaultUnitsRequired:
    'Default Units must be greater than 0.',
  serviceProcedureDefaultUnitsInvalid:
    'Default Units must be a whole number greater than 0.',
  ...
  staffLicenseTypeSearchPlaceholder: 'Search license type...',
  staffLicenseTypeSelectStateFirst: 'Select an issuing state first',
  staffLicenseIdentifierLabel: 'License number',
  staffLicenseStateLabel: 'Issuing state',
  staffLicenseStateSearchPlaceholder: 'Search state...',
  ...
  staffLicenseSourceLabel: 'Source',
  ...
  staffLicenseStateRequired: 'Issuing state is required.',
  ...
  staffLicenseDuplicate:
    'This license is already registered for this clinician.',
  ...
  clinicalNoteTemplateListTitle: 'Clinical Note Templates',
  clinicalNoteTemplateListSubtitle:
    'Define how generated clinical notes are assembled from '
    + 'encounter data and narrative fields.',
  clinicalNoteTemplateListSearchPlaceholder: 'Search templates',
  clinicalNoteTemplateListAdd: 'New template',
  clinicalNoteTemplateListError:
    'Could not load clinical note templates.',
  clinicalNoteTemplateNameLabel: 'Name',
  clinicalNoteTemplateDescriptionLabel: 'Description',
  clinicalNoteTemplateStatusLabel: 'Status',
  clinicalNoteTemplateVersionLabel: 'Version',
  clinicalNoteTemplateStatusActive: 'Active',
  clinicalNoteTemplateStatusInactive: 'Inactive',
  clinicalNoteTemplateAddTitle: 'Add Clinical Note Template',
  clinicalNoteTemplateEditTitle: 'Edit Clinical Note Template',
  clinicalNoteTemplateViewTitle: 'View Clinical Note Template',
  clinicalNoteTemplateBuilderHint:
    'Configure the order, labels, and sources used when a clinical '
  ...
  clinicalNoteTemplatePreviewHint:
    'Preview of final note order. This does not create encounter '
    + 'or note data.',
  clinicalNoteTemplatePreviewUntitled: 'Untitled template',
  clinicalNoteTemplateDuplicate: 'Duplicate',
  clinicalNoteTemplateActivate: 'Activate',
  clinicalNoteTemplateDeactivate: 'Deactivate',
  clinicalNoteTemplateSaveSuccess: 'Template saved.',
  clinicalNoteTemplateSaveError: 'Could not save the template.',
  clinicalNoteTemplateDuplicateSuccess: 'Template duplicated.',
  ...
  clinicalNoteSectionAutoData: 'Automatic data',
  clinicalNoteSectionNarrative: 'Narrative field',
  clinicalNoteSectionAssessment: 'Assessment',
  clinicalNoteSectionStructured: 'Structured section',
  clinicalNotePreviewAuto: 'Automatic from {source}',
  clinicalNotePreviewNarrative: 'Clinician enters this during the visit.',
  ...
  'clinicalNoteDataSource_MEDICATIONS': 'Medications',
  'clinicalNoteDataSource_CARE_PLAN': 'Care plan',
  'clinicalNoteDataSource_FOLLOW_UP': 'Follow up',
  ...
  clinicalNoteAddendumReason: 'Reason',
  clinicalNoteAddendumReasonPlaceholder:
    'Why is this amendment required?',
  clinicalNoteAddendumReasonRequired:
    'A reason is required for the addendum.',
  clinicalNoteAddendumReasonMeta: 'Reason: {reason}',
  ...
  clinicalNoteStatusAmended: 'Amended',
  clinicalNoteStatusVoided: 'Voided',
  ...
  authorizationsSubtitle:
    'Manage and track service authorizations for this client.',
  authorizationAdd: 'New Authorization',
  authorizationAddTitle: 'Add Authorization',
  authorizationAddSubtitle:
    'Create a new service authorization for this client.',
  authorizationEditTitle: 'Edit Authorization',
  authorizationViewTitle: 'Authorization Details',
  authorizationCreate: 'Create Authorization',
  authorizationSave: 'Save Authorization',
  authorizationSaveClientFirst:
    'Save the client first to create and manage authorizations.',
  authorizationNoPermission:
    'You do not have permission to view authorizations.',
  authorizationListEmpty: 'No authorizations recorded.',
  authorizationListEmptyHint:
    'Authorizations required by specific services can be added here.',
  authorizationSectionBasic: 'Basic Information',
  authorizationSectionDetails: 'Authorization Details',
  authorizationSectionSupporting: 'Supporting Information',
  authorizationSectionAttachments: 'Attachment (Optional)',
  authorizationInsurance: 'Insurance',
  authorizationService: 'Service / Procedure',
  authorizationStatus: 'Status',
  authorizationQuantityType: 'Quantity Type',
  authorizationNumber: 'Authorization Number',
  authorizationNumberPlaceholder: 'Enter authorization number',
  authorizationRequestedDate: 'Requested Date',
  authorizationRequestedQty: 'Requested {unit}',
  authorizationApprovedQty: 'Approved {unit}',
  authorizationRequestedHint:
    'Number of visits, units or sessions requested.',
  authorizationStartDate: 'Start Date',
  authorizationEndDate: 'End Date',
  authorizationPriority: 'Priority',
  authorizationNotes: 'Notes',
  authorizationNotesPlaceholder:
    'Add any notes about this authorization request...',
  authorizationProvider: 'Requesting Provider',
  authorizationProviderHint:
    'Provider submitting the authorization request.',
  authorizationVerification: 'Verification Source',
  authorizationTracking: 'Reference / Tracking #',
  authorizationTrackingPlaceholder:
    'Enter reference or tracking number',
  authorizationDenialReason: 'Denial Reason',
  authorizationPendingBanner:
    'This authorization request will be created with a status of '
    + 'Pending.',
  authorizationNotRequiredWarning:
    'This Service is currently configured as not requiring '
    + 'authorization. An authorization record is not needed.',
  authorizationCoverageWarning:
    'Authorization dates extend beyond the insurance coverage period.',
  authorizationOverlapWarning:
    'Another approved authorization already overlaps this service, '
    + 'insurance and date range.',
  authorizationColService: 'Service / Procedure',
  authorizationColInsurance: 'Insurance',
  authorizationColStatus: 'Status',
  authorizationColNumber: 'Auth #',
  authorizationColApproved: 'Approved',
  authorizationColUsedRemaining: 'Used / Remaining',
  authorizationColStart: 'Start Date',
  authorizationColEnd: 'End Date',
  ...
  authorizationStatusExhausted: 'Exhausted',
  authorizationQtyVisits: 'Visits',
  authorizationQtyUnits: 'Units',
  authorizationPriorityRoutine: 'Routine',
  authorizationPriorityUrgent: 'Urgent',
  authorizationVerifyPortal: 'Payer Portal',
  authorizationVerifyPhone: 'Phone Call',
  authorizationVerifyFax: 'Fax',
  authorizationVerifyEmail: 'Email',
  authorizationVerifyOther: 'Other',
  authorizationCancelTitle: 'Cancel Authorization?',
  authorizationCancelMessage:
    'This authorization will remain in the client history.',
  authorizationCancelDetail:
    '{number} — {service}. This authorization will remain in the '
    + 'client history.',
  authorizationCancelConfirm: 'Cancel Authorization',
  authorizationCancelReason: 'Reason',
  authorizationActionView: 'View',
  authorizationActionEdit: 'Edit',
  authorizationActionCancel: 'Cancel authorization',
  authorizationCreated: 'Authorization created successfully.',
  authorizationUpdated: 'Authorization updated successfully.',
  ...
  authorizationServiceMeta:
    'Duration: {duration} • CPT: {cpt} • HCPCS: {hcpcs}',
  authorizationInsuranceRequired: 'Insurance is required.',
  authorizationServiceRequired: 'Service / Procedure is required.',
  authorizationStatusRequired: 'Status is required.',
  authorizationQuantityTypeRequired: 'Quantity type is required.',
  authorizationRequestedDateRequired: 'Requested date is required.',
  authorizationRequestedQtyRequired: 'Requested quantity is required.',
  authorizationApprovedQtyRequired:
    'Approved quantity must be greater than 0.',
  authorizationStartRequired: 'Start date is required.',
  authorizationEndRequired: 'End date is required.',
  authorizationEndBeforeStart:
    'End date cannot precede start date.',
  authorizationProviderRequired: 'Requesting provider is required.',
  authorizationDenialRequired: 'Denial reason is required.',
  authorizationLoadError: 'Could not load authorizations.',
  authorizationSaveError: 'Could not save the authorization.',
  authorizationCancelError: 'Could not cancel the authorization.',
  authorizationDocumentsAfterSave:
    'Save the authorization first to attach supporting documents.',
  authorizationDocumentUploadSuccess: 'Document uploaded.',
  authorizationDocumentUploadError: 'Could not upload the document.',
  authorizationDocumentDownloadError:
    'Could not download the document.',
  authorizationDocumentDeleteError: 'Could not remove the document.',
  ...
  appointmentDetailEncounterLabel: 'Encounter',
  appointmentDetailEncounterTitle: 'Start visit',
  appointmentDetailEncounterHint: 'Open the clinical encounter',
  appointmentDetailEncounterContinueTitle: 'Continue visit',
  appointmentDetailEncounterContinueHint: 'Encounter is in progress',
  appointmentDetailTeleconsultLabel: 'Teleconsult',
  appointmentDetailTeleconsultTitle: 'Join teleconsult',
  appointmentDetailTeleconsultHint: 'Start the video visit',
  ...
  appointmentDetailStatusScheduledHint: 'Appointment is scheduled',
  ...
  appointmentActionCheckIn: 'Confirm',
  ...
  appointmentAvailabilityRangesHint:
    'White = open. Teal stripe = client unavailable. '
    + 'Green = clinician booked. Yellow = break. Gray = outside hours.',
  ...
  appointmentAvailabilityClientBusyBlock: 'Client unavailable · {time}',
  ...
  appointmentBookingClientConflict:
    'This client already has an appointment during '
    + 'the selected time. Choose another time.',
  appointmentBookingClinicianConflict:
    'This clinician is not available during the selected time.',
  appointmentBookingBothConflict:
    'The selected time is unavailable for both '
    + 'the client and clinician.',
  appointmentOverlapping: 'Allow clinician overlap',
  appointmentOverlappingHint:
    'Applies to clinician scheduling only. '
    + 'The client cannot be booked into overlapping appointments.',
  ...
  appointmentSelectClientOrClinicianFirst:
    'Select a client or clinician to view the schedule.',
  ...
  appointmentLegendClientUnavailable: 'Client unavailable',
  appointmentLegendClinicianUnavailable: 'Clinician unavailable',
  ...
  appointmentCheckInSuccess: 'Appointment confirmed.',
  ...
  activeEncounterToolbarMetaPaused: '{type} · Paused',
  activeEncounterToolbarMetaReady: '{type} · Ready to resume',
  ...
  subTabFinancialOverview: 'Overview',
  subTabLedger: 'Ledger',
  ...
  assignCliniciansAssign: 'Assign',
  assignCliniciansUnassign: 'Remove from assigned',
  assignCliniciansClearAll: 'Clear all',
  ...
  assignCliniciansEmptyAvailableHint:
    ...
    + 'to this client.',
  assignCliniciansEmptySearch: 'No clinicians found.',
  ...
  assignCliniciansShowing:
    'Showing {from} to {to} of {total} clinicians',
  ...
  prefCommClientDeclined: 'Client declined to specify',
  ...
  encounterWaitTitle: 'Pause',
  encounterWaitHint:
    'The encounter stays open until the selected results '
    + 'are available.',
  encounterWaitLabs: 'Pending results',
  encounterWaitNoPendingLabs:
    'No pending diagnostic orders on this encounter.',
  encounterWaitNoPendingLabsHint:
    'Order a lab or diagnostic test before pausing.',
  encounterWaitUnnamedLab: 'Lab order',
  encounterWaitReason: 'Reason',
  encounterWaitReasonPlaceholder:
    'Urgent results required before continuing treatment.',
  encounterWaitReasonDefault:
    'Urgent results required before continuing treatment.',
  encounterWaitConfirm: 'Pause',
  encounterWaitSuccess: 'Encounter paused while waiting for results.',
  encounterWaitError: 'Could not pause the encounter.',
  encounterResumeSuccess: 'Encounter resumed.',
  encounterResumeError: 'Could not resume the encounter.',
  notificationsTitle: 'Notifications',
  notificationsEmpty: 'No notifications.',
  notificationsFallbackTitle: 'Results are ready',
  ...
  notificationsDeleteError: 'Could not delete the notification.',
  ...
  encounterStatusWaitingForResults: 'Waiting for Results',
  encounterStatusReadyToResume: 'Ready to Resume',
  ...
  encounterBillingReadyBody:
    'All required billing information is complete.',
  ...
  billingReviewHoldHint:
    'Release Billing Hold before review.',
  billingQueueNeedsAttention: 'Needs Attention',
  billingQueueNeedsAttentionHint: 'Requires action.',
  billingQueueReadyForReview: 'Ready for Review',
  billingQueueReadyForReviewHint: 'Ready to review.',
  billingQueueOnHold: 'On Hold',
  billingQueueOnHoldHint: 'Waiting on something.',
  billingQueueReviewed: 'Reviewed',
  billingQueueReviewedHint: 'Completed.',
  billingQueueAll: 'All',
  billingQueueAllSuperbills: 'All Superbills',
  billingQueueAllHint: 'Total in range.',
  billingQueueRefresh: 'Refresh',
  billingQueueEmptyOnHold: 'No Superbills are currently on hold.',
  billingQueueServiceCount:
    '{count} services | 1 service | {count} services',
  billingQueueBlockers:
    '{count} blockers | 1 blocker | {count} blockers',
  billingQueueWarnings:
    '{count} warnings | 1 warning | {count} warnings',
  billingQueueRequiresAction: 'Requires action.',
  billingQueueWarningHint: 'Review warnings.',
  billingQueueReadyHint: 'All requirements met.',
  superbillColumnReadiness: 'Readiness',
  billingQueueSearchPlaceholder:
    'Search client, superbill or encounter...',
  billingQueueDosToday: 'Today',
  billingQueueDosLast7: 'Last 7 Days',
  billingQueueDosLast30: 'Last 30 Days',
  billingQueueDosCustom: 'Custom Range',
  billingQueueDosAll: 'All Dates',
  billingQueueDosFrom: 'From',
  billingQueueDosTo: 'To',
  billingQueueAllProviders: 'All Providers',
  billingQueueAllPayers: 'All',
  billingQueueAllLocations: 'All',
  billingQueueServicePlaceholder: 'Service',
  billingQueueShowVoided: 'Show Voided',
  billingQueueSortDosNewest: 'Sort: Date of Service (Newest)',
  billingQueueSortDosOldest: 'Sort: Date of Service (Oldest)',
  billingQueueSortNumber: 'Sort: Superbill Number',
  billingQueueSortClient: 'Sort: Client',
  billingQueueSortStatus: 'Sort: Status',
  billingQueueSortTotal: 'Sort: Total Charge',
  billingQueueItemCount: '{count} items',
  billingQueuePaginationSummary:
    '{from}–{to} of {total} items',
  billingQueueEmptyNeedsAttention:
    'No billing issues require attention.',
  billingQueueEmptyReady:
    'No Superbills are currently ready for review.',
  billingQueueEmptyReviewed: 'No reviewed Superbills yet.',
  billingQueueEmptyAll: 'No superbills found.',
  billingQueueReview: 'Review',
  billingQueueView: 'View',
  billingQueueAging: '{days} days',
  superbillColumnService: 'Service',
  superbillColumnPayer: 'Payer / Responsibility',
  superbillDuration: 'Duration',
  superbillServiceMapping: 'Service mapping',
  superbillPrint: 'Print Superbill',
  billingEvidenceCoverageStart: 'Coverage start',
  billingEvidenceCoverageEnd: 'Coverage end',
  billingEvidenceValidForDos: 'Valid for Date of Service',
  billingEvidenceSource: 'Source',
  billingEvidenceSignedBy: 'Signed by',
  billingEvidenceSignedAt: 'Signed at',
  superbillHistoryStatusChanged: 'Status changed',
  superbillHistoryNoteCreated: 'Billing note added',
  encounterReturnToBilling: 'Return to Superbill',
  superbillListSearchPlaceholder:
    'Search by number, client or payer',
  superbillListEmpty: 'No superbills found.',
  superbillListLoadError: 'Could not load superbills.',
  superbillListPaginationSummary:
    '{from}–{to} of {total} superbills',
  superbillColumnNumber: 'Superbill',
  superbillColumnClient: 'Client',
  superbillColumnDos: 'Date of Service',
  superbillColumnProvider: 'Rendering Provider',
  superbillColumnInsurance: 'Insurance',
  superbillColumnTotal: 'Total',
  superbillColumnStatus: 'Status',
  superbillColumnIssues: 'Issues',
  superbillStatusAll: 'All statuses',
  superbillStatusNotReady: 'Not ready',
  superbillStatusReady: 'Ready',
  superbillStatusReviewed: 'Reviewed',
  superbillStatusVoided: 'Voided',
  superbillTitle: 'Superbill {number}',
  superbillBackToList: 'Back to Superbill List',
  superbillActions: 'Actions',
  superbillMarkReviewed: 'Mark Reviewed',
  superbillReopen: 'Reopen Superbill',
  superbillVoid: 'Void Superbill',
  superbillViewEncounter: 'View Encounter',
  superbillTabOverview: 'Overview',
  superbillTabServices: 'Services',
  superbillServicesEmpty:
    'No services were copied from this encounter.',
  superbillTabDiagnoses: 'Diagnoses',
  superbillTabBillingInfo: 'Billing Info',
  superbillTabHistory: 'History',
  superbillMetaClient: 'Client',
  superbillMetaDos: 'Date of Service',
  superbillMetaEncounter: 'Encounter',
  superbillMetaPayer: 'Payer',
  superbillMetaTotal: 'Total Charges',
  superbillReadiness: 'Billing Readiness',
  superbillReadinessAlert:
    '{count} items need attention. Resolve the items below '
    + 'to make this superbill ready for billing.',
  superbillReadinessReadyTitle: 'Ready for Billing',
  superbillReadinessReadyBody:
    'All required billing information is complete.',
  superbillSummary: 'Summary',
  superbillSummaryServices: 'Services',
  superbillSummaryUnits: 'Units',
  superbillSummaryCharges: 'Total Charges',
  superbillSummaryDos: 'Date of Service',
  superbillStatusCard: 'Superbill Status',
  superbillCreatedOn: 'Created on {when}',
  superbillRelated: 'Related Information',
  superbillRenderingProvider: 'Rendering Provider',
  superbillBillingProvider: 'Billing Provider',
  superbillLocation: 'Location',
  superbillPlaceOfService: 'Place of Service',
  superbillHelpfulLinks: 'Helpful Links',
  superbillViewClient: 'View Client Profile',
  superbillViewInsurance: 'View Insurance Profile',
  superbillNotes: 'Notes',
  superbillNotesEmpty: 'No billing notes added yet',
  superbillAddNote: 'Add Note',
  superbillAddNoteTitle: 'Add billing note',
  superbillNoteBodyLabel: 'Note',
  superbillNoteBodyPlaceholder: 'Enter a billing-specific note',
  superbillFooterId: 'Superbill ID: {number}',
  superbillFooterUpdated: 'Last updated: {when}',
  superbillSelfPay: 'Self pay',
  superbillAuthNotRequired: 'Not required for this Service',
  superbillAuthRequiredMissing: 'Required — Missing',
  superbillPrimary: 'Primary',
  superbillSecondary: 'Secondary',
  superbillNpi: 'NPI {npi}',
  superbillMrn: 'MRN {number}',
  superbillLoadError: 'Could not load this superbill.',
  superbillReviewSuccess: 'Superbill marked as reviewed.',
  superbillReviewRejected:
    'Superbill can no longer be reviewed. '
    + 'Resolve the items that need attention.',
  superbillVoidTitle: 'Void Superbill',
  superbillVoidMessage:
    'This superbill will be invalidated. It will not be deleted.',
  superbillVoidReasonLabel: 'Reason',
  superbillVoidReasonPlaceholder:
    'Why is this superbill being voided?',
  superbillVoidConfirm: 'Void Superbill',
  superbillReasonRequired: 'A reason is required.',
  superbillVoidSuccess: 'Superbill voided.',
  superbillReopenTitle: 'Reopen Superbill',
  superbillReopenMessage:
    'Billing readiness will be reevaluated after reopening.',
  superbillReopenReasonLabel: 'Reason',
  superbillReopenReasonPlaceholder:
    'Why is this superbill being reopened?',
  superbillReopenConfirm: 'Reopen',
  superbillReopenSuccess: 'Superbill reopened.',
  superbillNoteSuccess: 'Billing note added.',
  superbillPutOnHold: 'Put On Hold',
  superbillReleaseHold: 'Release Hold',
  superbillHoldTitle: 'Put Superbill On Hold',
  superbillHoldMessage:
    'On Hold is operational and does not change Superbill status.',
  superbillHoldReason: 'Reason',
  superbillHoldNotes: 'Notes',
  superbillHoldNotesPlaceholder: 'Add context for the billing team...',
  superbillHoldConfirm: 'Put On Hold',
  superbillHoldReasonRequired: 'A hold reason is required.',
  superbillHoldNotesRequired:
    'Notes are required when the reason is Other.',
  superbillHoldWaitingAuthorization: 'Waiting for authorization',
  superbillHoldWaitingInsurance: 'Waiting for insurance',
  superbillHoldWaitingProvider: 'Waiting for provider',
  superbillHoldWaitingDocumentation: 'Waiting for documentation',
  superbillHoldInternalReview: 'Internal review',
  superbillHoldOther: 'Other',
  superbillHoldSuccess: 'Superbill placed on hold.',
  superbillReleaseHoldSuccess: 'Billing Hold released.',
  superbillHistoryPutOnHold: 'Placed on hold',
  superbillHistoryHoldReleased: 'Hold released',
  superbillHistoryReady: 'Ready',
  superbillAuthNumber: 'Authorization No.',
  superbillAuthRemaining: 'Remaining',
  superbillAuthApproved: 'Approved visits',
  superbillAuthValidFrom: 'Valid from',
  superbillAuthValidTo: 'Valid to',
  superbillDocumentation: 'Documentation',
  superbillClinicalNote: 'Clinical Note',
  superbillNoteStatus: 'Status',
  superbillViewNote: 'View Note',
  superbillReviewAuthorization: 'Review Authorization',
  superbillReviewDiagnosis: 'Review Encounter Diagnoses',
  superbillReviewedBy: '{name}',
  superbillCpt: 'CPT',
  superbillService: 'Service',
  superbillUnits: 'Units',
  superbillPos: 'POS',
  superbillCharge: 'Charge',
  superbillAuthorization: 'Authorization',
  superbillDiagnoses: 'Diagnoses',
  superbillBillingResponsibility: 'Billing responsibility',
  superbillPayerName: 'Payer',
  superbillInsuranceType: 'Type',
  superbillMemberId: 'Member ID',
  superbillDob: 'DOB',
  superbillHistoryEmpty: 'No billing history recorded yet.',
  superbillHistoryReviewed: 'Reviewed',
  superbillHistoryVoided: 'Voided',
  superbillHistoryReopened: 'Reopened',
  superbillHistoryCreated: 'Created',
  superbillMissingValue: 'Not available',
  superbillViewFromEncounter: 'View Superbill',
  ...
  superbillReqPlaceOfService: 'Place of Service',
  superbillReqRenderingClinician: 'Rendering Provider',
  superbillReqBillableService: 'Billable Service',
  superbillReqBillingCode: 'Services / CPT-HCPCS Codes',
  superbillReqCharge: 'Charges',
  superbillReqUnits: 'Units',
  superbillReqPrimaryDiagnosis: 'Diagnosis',
  superbillReqInsurance: 'Insurance',
  superbillReqEligibility: 'Eligibility',
  superbillReqAuthorization: 'Authorization',
  superbillReqServiceDiagnosis: 'Diagnosis linked to Service',
  superbillReqClinicalNote: 'Clinical Note Signed',
  superbillReqBilled: 'Already billed',
  ...
  encounterProcessingRetry: 'Retry',
  encounterProcessingRetrySuccess: 'Processing retry completed.',
  encounterProcessingRetryError: 'Could not retry processing.',
  encounterProcessingNoteFailed: 'Clinical Note generation failed',
  encounterProcessingSuperbillFailed: 'Superbill generation failed',
  encounterProcessingFailedFallback:
    'A downstream process failed. Retry is available.',
  encounterGeneratedNoteTitle: 'Clinical Note',
  encounterGeneratedNoteReady: 'Ready for Review',
  encounterGeneratedNoteFailed:
    'Clinical note generation failed. You can retry '
  ...
  encounterGeneratedNoteMissing:
    'The clinical note is not available yet.',
  ...
  claimWorkspaceSubtitle:
    'Track Professional Claims generated from reviewed Superbills.',
  claimQueueNeedsAttention: 'Needs Attention',
  claimQueueNeedsAttentionHint: 'Draft claims with blockers.',
  claimQueueReady: 'Ready',
  claimQueueReadyHint: 'Structurally complete for submission.',
  claimQueueSubmitted: 'Submitted',
  claimQueueSubmittedHint: 'Transmitted and awaiting acknowledgment.',
  claimQueueAccepted: 'Accepted',
  claimQueueAcceptedHint:
    'Accepted and awaiting payer adjudication.',
  claimQueueRejected: 'Rejected',
  claimQueueRejectedHint: 'Rejected before adjudication.',
  claimQueuePaid: 'Paid',
  claimQueuePaidHint: 'Adjudicated with payer payment.',
  claimQueuePartiallyPaid: 'Partially Paid',
  claimQueuePartiallyPaidHint: 'Mixed paid and denied lines.',
  claimQueueDenied: 'Denied',
  claimQueueDeniedHint: 'Reached adjudication and was denied.',
  claimQueueAll: 'All',
  claimQueueAllHint: 'Active professional claims.',
  claimQueueRefresh: 'Refresh',
  claimQueueSearchPlaceholder:
    'Search claim #, client or superbill...',
  claimQueueDosToday: 'Today',
  claimQueueDosLast7: 'Last 7 Days',
  claimQueueDosLast30: 'Last 30 Days',
  claimQueueDosCustom: 'Custom Range',
  claimQueueDosAll: 'All Dates',
  claimQueueDosFrom: 'From',
  claimQueueDosTo: 'To',
  claimQueueAllProviders: 'All Providers',
  claimQueueAllPayers: 'All Payers',
  claimQueueServicePlaceholder: 'Service',
  claimQueueShowVoided: 'Show Voided',
  claimQueueSortDosNewest: 'Sort: Date of Service (Newest)',
  claimQueueSortDosOldest: 'Sort: Date of Service (Oldest)',
  claimQueueSortNumber: 'Sort: Claim Number',
  claimQueueSortClient: 'Sort: Client',
  claimQueueSortStatus: 'Sort: Status',
  claimQueueSortTotal: 'Sort: Total Charge',
  claimQueueItemCount: '{count} items',
  claimQueuePaginationSummary:
    '{from}–{to} of {total} items',
  claimQueueEmptyNeedsAttention:
    'No claims currently need attention.',
  claimQueueEmptyReady: 'No ready claims yet.',
  claimQueueEmptySubmitted: 'No submitted claims yet.',
  claimQueueEmptyAccepted: 'No accepted claims yet.',
  claimQueueEmptyRejected: 'No rejected claims yet.',
  claimQueueEmptyPaid: 'No paid claims yet.',
  claimQueueEmptyPartiallyPaid: 'No partially paid claims yet.',
  claimQueueEmptyDenied: 'No denied claims yet.',
  claimQueueEmptyAll: 'No claims found.',
  claimQueueView: 'View',
  claimQueueBlockers:
    '{count} blockers | 1 blocker | {count} blockers',
  claimQueueWarnings:
    '{count} warnings | 1 warning | {count} warnings',
  claimQueueRequiresAction: 'Requires action.',
  claimQueueReadyBody: 'All blocking requirements are met.',
  claimListLoadError: 'Could not load claims.',
  claimColumnNumber: 'Claim #',
  claimColumnClient: 'Client',
  claimColumnDos: 'Date of Service',
  claimColumnPayer: 'Payer',
  claimColumnService: 'Service(s)',
  claimColumnProvider: 'Rendering Provider',
  claimColumnTotal: 'Total Charge',
  claimColumnStatus: 'Status',
  claimColumnIssues: 'Issues / Response',
  claimColumnLastActivity: 'Last Activity',
  claimStatusDraft: 'Draft',
  claimStatusReady: 'Ready',
  ...
  claimProcessingStatus: 'Processing status',
  claimDisplayStatus: 'Display status',
  claimAdjudicationDimension: 'Adjudication',
  claimAdjudicationPending: 'Pending',
  claimAdjudicationAdjudicated: 'Adjudicated',
  claimDenialDimension: 'Denial',
  claimDenialNone: 'None',
  claimDenialPartial: 'Partial',
  claimDenialFull: 'Full',
  claimPayerPaymentDimension: 'Payer payment',
  claimPayerPaymentNone: 'None',
  claimPayerPaymentPartial: 'Partial',
  claimPayerPaymentPaid: 'Paid',
  claimDisplayAwaitingAdjudication:
    'Accepted — Awaiting Adjudication',
  claimTitle: 'Claim {number}',
  claimReadiness: 'Claim Readiness',
  claimReadinessReadyTitle: 'This Claim is structurally ready.',
  claimReadinessReadyBody:
    'All blocking Claim Readiness requirements are satisfied.',
  claimReadinessAlert:
    '{count} items need attention | 1 item needs attention | '
    + '{count} items need attention',
  claimReadinessVoided: 'This Claim has been voided.',
  claimTabOverview: 'Overview',
  claimTabPatient: 'Client & Subscriber',
  claimTabServices: 'Services',
  claimTabDiagnoses: 'Diagnoses',
  claimTabProviders: 'Providers',
  claimTabInformation: 'Claim Information',
  claimTabSubmission: 'Submission',
  claimTabAdjudication: 'Adjudication',
  claimTabPayments: 'Payments',
  claimTabHistory: 'History',
  claimCategoryPatient: 'Client',
  claimCategorySubscriber: 'Subscriber & Insurance',
  claimCategoryPayer: 'Payer',
  claimCategoryProviders: 'Providers',
  claimCategoryInformation: 'Claim Information',
  claimCategoryServices: 'Claim Lines',
  claimCategoryDiagnoses: 'Diagnoses',
  claimCategoryRoute: 'Submission route',
  claimCategorySubmitter: 'Submitter',
  claimCategoryReceiver: 'Receiver',
  claimCategoryFormat: 'Format',
  claimCategoryClaim: 'Claim',
  claimMetaClient: 'Client',
  claimMetaDos: 'Date of Service',
  claimMetaPayer: 'Payer',
  claimMetaTotal: 'Total',
  claimSourceSuperbill: 'Source Superbill',
  claimSourceVersion: 'Source Version',
  claimViewSuperbill: 'View Superbill',
  claimViewInsurance: 'View Insurance',
  claimViewProvider: 'View Provider Configuration',
  claimViewClient: 'View Client',
  claimViewSource: 'View Source',
  claimViewSubmissionRoute: 'View Submission Configuration',
  claimPatient: 'Client',
  claimSubscriber: 'Subscriber',
  claimName: 'Name',
  claimDob: 'Date of birth',
  claimSex: 'Sex',
  ...
  claimPos: 'POS',
  claimCharge: 'Charge',
  claimServicesEmpty: 'No claim lines.',
  claimDiagnosesEmpty: 'No diagnoses.',
  claimPrimaryDiagnosis: 'PRIMARY',
  claimServiceMapping: 'Service mapping',
  claimDiagnosisPointers: 'Pointers {pointers}',
  claimModifiers: 'Modifiers {modifiers}',
  claimBillingProvider: 'Billing Provider',
  claimRenderingProvider: 'Rendering Provider',
  claimNpi: 'NPI',
  claimTaxonomy: 'Taxonomy',
  claimType: 'Claim Type',
  claimTypeProfessional: 'Professional',
  claimCreatedAt: 'Date created',
  claimLoadError: 'Could not load this Claim.',
  claimVoid: 'Void Claim',
  claimVoidTitle: 'Void Claim',
  claimVoidMessage:
    'This Claim will be invalidated. It will not be deleted.',
  claimVoidReason: 'Reason',
  claimVoidNotes: 'Notes',
  claimVoidNotesPlaceholder: 'Required when the reason is Other.',
  claimVoidConfirm: 'Void Claim',
  claimVoidReasonRequired: 'Select a reason.',
  claimVoidNotesRequired: 'Notes are required for Other.',
  claimVoidSourceReopened: 'Source Superbill reopened',
  claimVoidCreatedInError: 'Created in error',
  claimVoidDuplicate: 'Duplicate',
  claimVoidOther: 'Other',
  claimVoidSuccess: 'Claim voided.',
  claimVoidError: 'Could not void the Claim.',
  claimHistoryEmpty: 'No claim history recorded yet.',
  claimHistoryCreated: 'Claim generated',
  claimHistoryStatusChanged: 'Status changed',
  claimHistoryReady: 'Ready',
  claimHistoryVoided: 'Voided',
  claimHistoryReadinessChanged: 'Claim readiness changed',
  claimHistorySubmissionCreated: '837P generated',
  claimHistorySubmitted: 'Submitted',
  claimHistorySubmissionFailed: 'Submission failed',
  claimHistory999Received: '999 received',
  claimHistory277caReceived: '277CA received',
  claimHistoryAccepted: 'Accepted for further processing',
  claimHistoryRejected: 'Claim rejected',
  claimHistoryAdjudicated: 'Claim adjudicated',
  claimHistoryPaid: 'Paid',
  claimHistoryPartiallyPaid: 'Partially paid',
  claimHistoryDenied: 'Denied after adjudication',
  claimSubmit: 'Submit Claim',
  claimSubmitTitle: 'Submit Claim?',
  claimSubmitMessage:
    'This Claim will be transmitted electronically.',
  claimSubmitConfirm: 'Submit',
  claimSubmitSuccess: 'Claim submitted.',
  claimSubmitError: 'Could not submit the Claim.',
  claimRetrySubmission: 'Retry transmission',
  claimRetrySuccess: 'Transmission retry started.',
  claimSubmissionReadyTitle: 'Ready to submit',
  claimSubmissionReadyBody:
    'Submission Readiness requirements are satisfied.',
  claimSubmissionNotReadyTitle: 'Not ready to submit',
  claimSubmissionNotReadyBody:
    '{count} blockers | 1 blocker | {count} blockers',
  claimSubmissionFormat: 'Format',
  claimSubmissionVersion: 'Version',
  claimSubmissionRoute: 'Route',
  claimSubmissionElectronicPayerId: 'Electronic Payer ID',
  claimSubmissionTracking: 'Tracking',
  claimSubmissionAttempt: 'Submission Attempt',
  claimSubmissionAwaitingAck: 'Awaiting acknowledgment',
  claimSubmissionAcceptedBody:
    'Accepted for further processing',
  claimSubmissionRejectedBody:
    '{count} issues require correction | '
    + '1 issue requires correction | '
    + '{count} issues require correction',
  claimAck999: '999',
  claimAck277ca: '277CA',
  claimAckReceived: 'Received',
  claimAckPending: 'Pending',
  claimAckAccepted: 'Accepted transaction',
  claimAckRejected: 'Claim rejected',
  claimRouteTitle: 'Submission Configuration',
  claimRouteHint:
    'Organization routing used to transmit Professional Claims.',
  claimRouteElectronicPayerId: 'Electronic Payer ID',
  claimRouteClearinghouse: 'Clearinghouse / Receiver name',
  claimRouteSubmitterId: 'Submitter ID',
  claimRouteSubmitterName: 'Submitter name',
  claimRouteReceiverId: 'Receiver ID',
  claimRouteReceiverName: 'Receiver name',
  claimRouteLoadError:
    'Could not load submission configuration.',
  claimRouteSaveError:
    'Could not save submission configuration.',
  claimRouteSaved: 'Submission configuration saved.',
  claimQueueSubmissionBlocker: 'Submission configuration issue.',
  claimQueueRejectionIssue: 'Rejected claim response.',
  claimQueueAwaitingAck: 'Awaiting acknowledgment.',
  superbillHasSubmittedClaim:
    'This Superbill has a submitted Claim. '
    + 'The billing snapshot cannot be reopened through '
    + 'the standard workflow.',
  superbillViewClaim: 'View Claim',
  superbillGenerateClaim: 'Generate Claim',
  superbillGenerateClaimSuccess: 'Professional Claim generated.',
  superbillGenerateClaimError:
    'Could not generate a Professional Claim.',
  remittanceWorkspaceTitle: 'Remittances',
  remittanceWorkspaceSubtitle:
    'Review ERA/835 remittances before posting insurance payments.',
  remittanceImportEra: 'Import ERA / 835',
  remittanceIngestTitle: 'Import ERA / 835',
  remittanceIngestSubtitle:
    'Paste a raw X12 835 or a structured remittance JSON payload.',
  remittanceIngestPayload: 'ERA payload',
  remittanceIngestPlaceholder: 'ISA*... or { "claims": [] }',
  remittanceIngestAutoPost: 'Post automatically when matching is exact',
  remittanceIngestConfirm: 'Process ERA',
  remittanceIngestSuccess: 'Remittance processed.',
  remittanceIngestError: 'Could not process the remittance.',
  remittanceDuplicateIgnored:
    'This ERA was already processed. No duplicate posting was created.',
  remittanceListLoadError: 'Could not load remittances.',
  remittanceQueueNeedsReview: 'Needs Review',
  remittanceQueueNeedsReviewHint: 'Unmatched claims or posting issues.',
  remittanceQueueReady: 'Ready to Post',
  remittanceQueueReadyHint: 'Matched and waiting to post.',
  remittanceQueuePosted: 'Posted',
  remittanceQueuePostedHint: 'Insurance payment applied.',
  remittanceQueueAll: 'All',
  remittanceQueueAllHint: 'All received remittances.',
  remittanceQueueSearchPlaceholder:
    'Search ERA #, payer or payment reference...',
  remittanceQueueEmptyNeedsReview: 'No remittances need review.',
  remittanceQueueEmptyReady: 'No remittances are ready to post.',
  remittanceQueueEmptyPosted: 'No posted remittances yet.',
  remittanceQueueEmptyAll: 'No remittances found.',
  remittanceColumnNumber: 'ERA #',
  remittanceColumnReceived: 'Received',
  remittanceColumnPayment: 'Payment',
  remittanceColumnClaims: 'Claims',
  remittanceProcessingPartial: 'Partially matched',
  remittanceProcessingFailed: 'Processing failed',
  remittanceProcessingProcessed: 'Processed',
  remittanceOverview: 'ERA / Remittance',
  remittanceNeedsAttention:
    '{count} claims could not be matched | '
    + '1 claim could not be matched | '
    + '{count} claims could not be matched',
  remittanceMatched: 'Matched',
  remittanceNeedsReview: 'Needs Review',
  remittancePostingStatus: 'Posting Status',
  remittanceClaimList: 'Remittance claims',
  remittanceReview: 'Review',
  remittancePost: 'Post payment',
  remittancePostSuccess: 'Insurance payment posted.',
  remittancePostError: 'Could not post this remittance.',
  claimAdjBilled: 'Billed',
  claimAdjAllowed: 'Allowed',
  claimAdjPaid: 'Payer Paid',
  claimAdjPatient: 'Client Responsibility',
  claimAdjAdjustments: 'Adjustments',
  claimAdjEra: 'ERA',
  claimAdjReceived: 'Received',
  claimAdjApplied: 'Applied to Claim',
  claimAdjudicationEmpty:
    'This Claim has not received payer adjudication yet.',
  claimDeniedNotPatientBalance:
    'Denied amounts are not automatically owed by the Client.',
  claimInsurancePaymentsHint:
    'Insurance payments applied from payer remittance. '
    + 'These are not Client payments.',
  claimInsurancePaymentsEmpty: 'No insurance payments posted yet.',
  paymentTrace: 'Trace',
  paymentWorkspaceTitle: 'Payments',
  paymentWorkspaceSubtitle:
    'Track and manage insurance payments from ERA/835 remittances.',
  paymentTabInsurance: 'Insurance Payments',
  paymentTabPatient: 'Client Payments',
  paymentSearchPlaceholder:
    'Search by payer, check #, claim # or client',
  paymentListLoadError: 'Could not load insurance payments.',
  paymentQueueEmpty: 'No insurance payments found.',
  paymentEraHint:
    'Payments imported from ERA/835 are reviewed automatically. '
    + 'Verify and post to update Claim adjudication.',
  paymentCardTotalReceived: 'Total Received',
  paymentCardPayments: 'Payments',
  paymentCardInProcess: 'In Process',
  paymentCardPending: 'Pending Posting',
  paymentCardAdjustments: 'Total Adjustments',
  paymentCardThisMonth: 'This Month',
  paymentCardCount:
    '{count} payments | 1 payment | {count} payments',
  paymentColumnNumber: 'Payment #',
  paymentColumnDate: 'Payment Date',
  paymentColumnMethod: 'Method',
  paymentColumnAmount: 'Received',
  paymentColumnUnallocated: 'Unallocated',
  paymentStatusPosted: 'Posted',
  paymentStatusInProcess: 'In Process',
  paymentStatusPending: 'Pending Posting',
  claimLineageTitle: 'Claim History',
  claimRelationshipOriginal: 'Original',
  claimRelationshipCorrected: 'Corrected',
  claimRelationshipReplacement: 'Replacement',
  denialWorkspaceTitle: 'Denials',
  denialWorkspaceSubtitle:
    'Work rejected claims, payer denials and denied '
    + 'service lines.',
  denialTitle: 'Denial {number}',
  denialListLoadError: 'Could not load denials.',
  denialLoadError: 'Could not load this denial case.',
  denialUpdateError: 'Could not update the denial case.',
  denialSaved: 'Denial case updated.',
  denialQueueNeedsReview: 'Needs Review',
  denialQueueNeedsReviewHint: 'New rejections and denials.',
  denialQueueInProgress: 'In Progress',
  denialQueueInProgressHint: 'Assigned and being worked.',
  denialQueueWaiting: 'Waiting',
  denialQueueWaitingHint: 'Waiting on source, payer or appeal.',
  denialQueueReady: 'Ready for Resubmission',
  denialQueueReadyHint: 'Corrected claim ready to submit.',
  denialQueueAppeal: 'Appeal',
  denialQueueAppealHint: 'Appeals in progress.',
  denialQueueResolved: 'Resolved',
  denialQueueResolvedHint: 'Closed denial cases.',
  denialQueueAll: 'All',
  denialQueueAllHint: 'All denial and rejection cases.',
  denialQueueSearchPlaceholder:
    'Search claim #, client, payer or reason code...',
  denialQueueEmptyNeedsReview: 'No denials need review.',
  denialQueueEmptyInProgress: 'No denials in progress.',
  denialQueueEmptyWaiting: 'No waiting denials.',
  denialQueueEmptyReady: 'No denials ready for resubmission.',
  denialQueueEmptyAppeal: 'No appeals in progress.',
  denialQueueEmptyResolved: 'No resolved denials.',
  denialQueueEmptyAll: 'No denial cases found.',
  denialColumnService: 'Service',
  denialColumnIssue: 'Issue Type',
  denialColumnAmount: 'Denied Amount',
  denialColumnPriority: 'Priority',
  denialColumnFollowUp: 'Follow Up',
  denialColumnCategory: 'Category',
  denialEntireClaim: 'Entire Claim',
  denialSourceRejection: 'Rejected',
  denialSourceDenial: 'Denied',
  denialSource: 'Source',
  denialSource277ca: '277CA',
  denialSource835: 'ERA / 835',
  denialCarc: 'CARC',
  denialRarc: 'RARC',
  denialGroupCode: 'Group Code',
  denialRejectionCode: 'Rejection Code',
  denialPayerResponse: 'Payer Response',
  denialPayerMessage: 'Payer Message',
  denialAffectedService: 'Affected Service',
  denialBilled: 'Billed',
  denialPaid: 'Paid',
  denialRootCauseSection: 'Root Cause',
  denialRootCause: 'Root Cause',
  denialRootCauseHint:
    'Operational category and root cause do not change '
    + 'payer codes.',
  denialNotes: 'Internal Notes',
  denialSuggestedActions: 'Suggested Actions',
  denialAppeals: 'Appeals',
  denialStartWork: 'Start Work',
  denialCorrectClaim: 'Correct Claim',
  denialCreateReplacement: 'Create Replacement',
  denialCreateClaim: 'Create Claim',
  denialCreateAppeal: 'Create Appeal',
  denialResolve: 'Resolve',
  denialViewClaim: 'View Claim',
  denialReviewInsurance: 'Review Insurance',
  denialReviewProvider: 'Review Provider',
  denialReviewSuperbill: 'Review Superbill',
  denialReviewAuthorization: 'Review Authorization',
  denialReviewClient: 'Review Client',
  denialReviewClaim: 'Review Claim',
  denialReopenSource: 'Reopen Billing Source',
  denialCorrectedClaim: 'Corrected Claim',
  denialCorrectHint:
    'Creates a new Claim from the current Superbill. '
    + 'The submitted Claim stays unchanged.',
  denialCorrectionReason: 'Correction Reason',
  denialAppealReason: 'Appeal Reason',
  denialAppealNarrative: 'Appeal Narrative',
  denialResolutionType: 'Resolution Type',
  denialWriteOffReference: 'Write-off Reference',
  denialCorrectSuccess: 'Corrected Claim created.',
  denialCorrectError: 'Could not create the corrected Claim.',
  denialAppealSuccess: 'Appeal created.',
  denialAppealError: 'Could not create the appeal.',
  denialResolveSuccess: 'Denial case resolved.',
  denialResolveError: 'Could not resolve the denial case.',
  denialReopenSourceSuccess: 'Billing source reopened for correction.',
  denialReopenSourceError:
    'Could not reopen the billing source.',
  'denialStatus.NEEDS_REVIEW': 'Needs Review',
  'denialStatus.IN_PROGRESS': 'In Progress',
  'denialStatus.WAITING': 'Waiting',
  'denialStatus.READY_FOR_RESUBMISSION': 'Ready for Resubmission',
  'denialStatus.APPEAL_REQUIRED': 'Appeal Required',
  'denialStatus.RESOLVED': 'Resolved',
  'denialStatus.CLOSED_NO_ACTION': 'Closed — No Action',
  'denialCategory.ELIGIBILITY': 'Eligibility',
  'denialCategory.AUTHORIZATION': 'Authorization',
  'denialCategory.PATIENT_INFORMATION': 'Client Information',
  'denialCategory.SUBSCRIBER_INFORMATION': 'Subscriber Information',
  'denialCategory.PAYER_INFORMATION': 'Payer Information',
  'denialCategory.PROVIDER_INFORMATION': 'Provider Information',
  'denialCategory.CREDENTIALING': 'Credentialing',
  'denialCategory.CODING': 'Coding',
  'denialCategory.DIAGNOSIS': 'Diagnosis',
  'denialCategory.SERVICE': 'Service',
  'denialCategory.MODIFIER': 'Modifier',
  'denialCategory.DUPLICATE': 'Duplicate',
  'denialCategory.TIMELY_FILING': 'Timely Filing',
  'denialCategory.MEDICAL_NECESSITY': 'Medical Necessity',
  'denialCategory.NON_COVERED_SERVICE': 'Non-Covered Service',
  'denialCategory.COORDINATION_OF_BENEFITS':
    'Coordination of Benefits',
  'denialCategory.DOCUMENTATION': 'Documentation',
  'denialCategory.OTHER': 'Other',
  ...
  'denialCorrectionReason.AUTHORIZATION': 'Authorization',
  'denialCorrectionReason.CODING': 'Coding',
  'denialCorrectionReason.DIAGNOSIS': 'Diagnosis',
  'denialCorrectionReason.SERVICE': 'Service',
  'denialCorrectionReason.MODIFIER': 'Modifier',
  'denialCorrectionReason.PAYER_INSTRUCTION': 'Payer instruction',
  'denialCorrectionReason.OTHER': 'Other',
  'denialResolution.CORRECTED_AND_RESUBMITTED':
    'Corrected and resubmitted',
  'denialResolution.REPLACEMENT_CLAIM_SUBMITTED':
    'Replacement claim submitted',
  'denialResolution.APPEAL_SUBMITTED': 'Appeal submitted',
  'denialResolution.PAID_AFTER_REPROCESSING':
    'Paid after reprocessing',
  ...
  clientFinancialLoadError: 'Could not load financial summary.',
  clientFinancialCurrentBalance: 'Current Balance',
  clientFinancialCurrentBalanceHint:
    'Calculated from posted ledger transactions.',
  clientFinancialClientResponsibility: 'Client Responsibility',
  clientFinancialClientResponsibilityHint:
    'Payer-assigned Client liability.',
  clientFinancialSelfPayBalance: 'Self-Pay Balance',
  clientFinancialSelfPayBalanceHint:
    'Charges from reviewed self-pay Superbills.',
  clientFinancialResponsibilityBreakdown:
    'Client Responsibility Breakdown',
  clientFinancialRecentActivity: 'Recent Activity',
  clientFinancialOpenObligations: 'Open Obligations',
  clientFinancialOpenObligationsHint:
    'Outstanding Copay, Deductible, Coinsurance and Self-Pay.',
  clientFinancialAvailableCredit: 'Available Credit',
  clientFinancialAvailableCreditHint:
    'Unapplied Client Payments that remain with the Client.',
  clientFinancialLastPayment: 'Last Payment',
  clientPaymentRecordTitle: 'Record Payment',
  clientPaymentRecordSubtitle:
    'Record money received from the Client and optionally apply it.',
  clientPaymentRecordConfirm: 'Record Payment',
  clientPaymentRecorded: 'Client payment recorded.',
  clientPaymentRecordError: 'Could not record the payment.',
  clientPaymentLoadError: 'Could not load Client Payments.',
  clientPaymentNoPermission:
    'You do not have permission to view Client Payments.',
  clientPaymentHistoryTitle: 'Payments',
  clientPaymentHistorySubtitle:
    'Money received from the Client and how it was applied.',
  clientPaymentSearchPlaceholder:
    'Search by payment # or reference',
  clientPaymentEmpty: 'No Client Payments recorded yet.',
  clientPaymentQueueEmpty: 'No Client Payments found.',
  clientPaymentAmount: 'Amount',
  clientPaymentDate: 'Payment Date',
  clientPaymentMethod: 'Payment Method',
  clientPaymentMethodDescription: 'Payment Method Description',
  clientPaymentReference: 'Reference Number',
  clientPaymentReferenceHint: 'Example: TXN-482901',
  clientPaymentCheckNumber: 'Check Number',
  clientPaymentNotes: 'Notes',
  clientPaymentAvailableBalance: 'Available Balance',
  clientPaymentApplyTitle: 'Apply Payment',
  clientPaymentApply: 'Apply',
  clientPaymentObligation: 'Obligation',
  clientPaymentOutstanding: 'Outstanding',
  clientPaymentApplyAmount: 'Amount',
  clientPaymentAutoApply: 'Auto Apply',
  clientPaymentApplied: 'Applied',
  clientPaymentUnapplied: 'Unapplied',
  clientPaymentNoObligations: 'No open obligations.',
  clientPaymentNoBalanceWarning:
    'This Client currently has no outstanding balance. '
    + 'Any recorded payment will remain as unapplied credit.',
  clientPaymentAllocation: 'Allocation',
  clientPaymentNoAllocations: 'No allocations on this payment.',
  clientPaymentDetailTitle: 'Payment {number}',
  clientPaymentApplyExisting: 'Apply Existing Payment',
  clientPaymentApplyExistingHint:
    'Unapplied amount available: {amount}',
  clientPaymentApplyConfirm: 'Apply',
  clientPaymentAllocated: 'Unapplied amount applied.',
  clientPaymentAllocateError: 'Could not apply the payment.',
  clientPaymentReverse: 'Reverse Payment',
  clientPaymentReverseTitle: 'Reverse Payment',
  clientPaymentReverseMessage:
    'Reversing restores open obligations and posts a ledger correction. '
    + 'The original payment remains visible.',
  clientPaymentReverseReason: 'Reversal Reason',
  clientPaymentReverseConfirm: 'Reverse Payment',
  clientPaymentReversed: 'Payment reversed.',
  clientPaymentReverseError: 'Could not reverse the payment.',
  clientPaymentNoLastPayment: 'No payment recorded',
  'clientPaymentMethod.CASH': 'Cash',
  'clientPaymentMethod.CARD': 'Card',
  'clientPaymentMethod.CHECK': 'Check',
  'clientPaymentMethod.OTHER': 'Other',
  'clientPaymentStatus.POSTED': 'Posted',
  'clientPaymentStatus.REVERSED': 'Reversed',
  'obligationState.OPEN': 'Open',
  'obligationState.PARTIALLY_PAID': 'Partially paid',
  'obligationState.PAID': 'Paid',
  clientLedgerTitle: 'Ledger',
  clientLedgerSubtitle:
    'Posted Client financial transactions and running balance.',
  clientLedgerNoPermission:
    'You do not have permission to view the Client Ledger.',
  clientLedgerLoadError: 'Could not load the Client Ledger.',
  clientLedgerEmpty: 'No ledger activity yet.',
  clientLedgerZeroBalance: '$0.00',
  clientLedgerSearchPlaceholder: 'Search reference or description',
  clientLedgerDateFrom: 'From date',
  clientLedgerDateTo: 'To date',
  clientLedgerColumnDate: 'Date',
  clientLedgerColumnDescription: 'Description',
  clientLedgerColumnType: 'Type',
  clientLedgerColumnReference: 'Reference',
  clientLedgerColumnCharge: 'Charge',
  clientLedgerColumnCredit: 'Credit',
  clientLedgerColumnBalance: 'Balance',
  clientLedgerColumnStatus: 'Status',
  clientLedgerColumnAmount: 'Amount',
  clientLedgerColumnSource: 'Source',
  clientLedgerColumnService: 'Service',
  clientLedgerColumnPayer: 'Payer',
  clientLedgerResponsibilityType: 'Responsibility type',
  clientLedgerDetailTitle: 'Ledger entry',
  clientLedgerDetailSubtitle:
    'Client-facing financial effect of this transaction.',
  clientLedgerViewClaim: 'View Claim',
  clientLedgerViewSuperbill: 'View Superbill',
  'ledgerEntryType.CLIENT_RESPONSIBILITY':
    'Client responsibility',
  'ledgerEntryType.SELF_PAY_CHARGE': 'Self-pay charge',
  'ledgerEntryType.CLIENT_PAYMENT': 'Client payment',
  ...
  'ledgerSourceType.PAYER_ADJUDICATION': 'Payer adjudication',
  'ledgerSourceType.SUPERBILL': 'Reviewed Superbill',
  'ledgerSourceType.CLIENT_PAYMENT': 'Client payment',
  'ledgerSourceType.LEDGER_REVERSAL': 'Ledger reversal',
  'ledgerResponsibility.COPAY': 'Copay',
  'ledgerResponsibility.DEDUCTIBLE': 'Deductible',
  'ledgerResponsibility.COINSURANCE': 'Coinsurance',
  'ledgerResponsibility.OTHER': 'Other',
}
