export default {
  ...
  subTabAssessments: 'Assessments',
  assessmentsTitle: 'Assessments',
  assessmentsSubtitle:
    'Complete clinical assessments from preconfigured templates.',
  assessmentNew: 'New Assessment',
  assessmentNewHint: 'Select a template to start a draft assessment.',
  ...
  assessmentComplete: 'Complete Assessment',
  assessmentSaveClientFirst:
    'Save the client first to create and manage assessments.',
  assessmentListEmpty: 'No assessments recorded for this client yet.',
  ...
  assessmentDraftSaved: 'Assessment draft saved successfully.',
  assessmentCompleted: 'Assessment completed successfully.',
  assessmentCompleteValidation:
    'Complete all required fields before finishing the assessment.',
  assessmentFieldRequired: 'This field is required.',
  assessmentTemplatesError: 'Could not load assessment templates.',
  assessmentListError: 'Could not load assessments.',
  assessmentLoadError: 'Could not load the assessment.',
  assessmentCreateError: 'Could not create the assessment.',
  assessmentSaveError: 'Could not save the assessment.',
