...
export const clientOverviewAltTestIds = {
  ...
  consents: 'client-overview-alt-consents',
...
export const addClientTestIds = {
  ...
  identityLockBadge: name => toTestId(
    'add-client-field',
    name,
    'admin-lock',
  ),
  identityReasonDialog: 'add-client-identity-reason-dialog',
  identityReasonField: 'add-client-identity-reason-field',
  identityReasonCancel: 'add-client-identity-reason-btn-cancel',
  identityReasonConfirm: 'add-client-identity-reason-btn-confirm',
