<template>
  <q-dialog
    v-model="open"
    persistent
    :data-testid="modalTestIds.dialog('diagnostic-study-cancel')"
    ...
    <q-card
      ...
      <q-card-actions
        ...
        <q-btn
          ...
          :data-testid="modalTestIds.cancel(
            'diagnostic-study-cancel',
          )"
          :label="t('cancel')"
          @click="onCancel"
        />
        <q-btn
          ...
          :data-testid="modalTestIds.confirm(
            'diagnostic-study-cancel',
          )"
          :label="t('dsActionCancel')"
          @click="onConfirm"
        />
      </q-card-actions>
    </q-card>
